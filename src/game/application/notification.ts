export type NotificationCode = 'clone-succeeded'|'no-empty-slot'|'insufficient-credits'|'unit-moved'|'units-swapped'|'units-merged'|'unit-discarded'|'item-equipped'|'max-star'|'interaction-locked'|'card-rerolled'|'card-applied'|'item-attached'|'round-skipped'|'cards-exhausted'
