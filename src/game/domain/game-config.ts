...
export type RoundDefinition = { kind: 'normal' | 'boss'; total: number; duration: number; bossId?: EnemyDefinitionId }
export type GameConfig = {
  ...
  balance: { fixedStep: number; spawnInterval: number; supportProjectileSpeed: number; rangePixels: number; normalHpGrowth: number }
}
